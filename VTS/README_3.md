...
## CONTEXT
Below is the original project description given, this is the final iteration of the project and becuase of that
some features are not listed below as tasks. READEME's of previous iterations can be found under the "pastIterations" folder. 
