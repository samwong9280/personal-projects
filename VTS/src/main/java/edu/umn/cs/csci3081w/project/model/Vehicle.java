...
public abstract class Vehicle implements VehicleObserver {
  ...
  public boolean provideInfo() {
    ...
    if (!isTripComplete()) {
      ...
      String type = "";
      if ((this instanceof SmallBusColorDecorator) || (this instanceof SmallBus)) {
        type = SmallBus.SMALL_BUS_VEHICLE;
      } else if ((this instanceof LargeBusColorDecorator) || (this instanceof LargeBus)) {
        type = LargeBus.LARGE_BUS_VEHICLE;
      } else if ((this instanceof ElectricTrainColorDecorator) || (this instanceof ElectricTrain)) {
        type = ElectricTrain.ELECTRIC_TRAIN_VEHICLE;
      } else if ((this instanceof DieselTrainColorDecorator) || (this instanceof DieselTrain)) {
