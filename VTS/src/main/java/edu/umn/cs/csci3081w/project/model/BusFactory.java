...
public class BusFactory implements VehicleFactory {
  ...
  public Vehicle generateVehicle(Line line) {
    ...
    if (typeOfVehicle != null && typeOfVehicle.equals(SmallBus.SMALL_BUS_VEHICLE)) {
      generatedVehicle = new SmallBusColorDecorator(new SmallBus(
         counter.getSmallBusIdCounterAndIncrement(),
      ...
      generatedVehicle = new LargeBusColorDecorator(new LargeBus(
         counter.getLargeBusIdCounterAndIncrement(),
  ...
  public void returnVehicle(Vehicle vehicle) {
    if (vehicle instanceof SmallBusColorDecorator) {
      storageFacility.incrementSmallBusesNum();
    } else if (vehicle instanceof LargeBusColorDecorator) {
