  ...
  public void update() {
    ...
    for (int i = activeVehicles.size() - 1; i >= 0; i--) {
      ...
      if (currVehicle.isTripComplete()) {
        ...
        if ((completedTripVehicle instanceof SmallBusColorDecorator)
                || (completedTripVehicle instanceof LargeBusColorDecorator)) {
          busFactory.returnVehicle(completedTripVehicle);
        } else if ((completedTripVehicle instanceof ElectricTrainColorDecorator)
                || (completedTripVehicle instanceof DieselTrainColorDecorator)) {
