...
public class LineTest {
  ...
  public void setUp() {
    ...
    testLine2 = new Line(1, "testLine2", Line.BUS_LINE, testRouteOut, testRouteIn, null);
  ...
  /**
   * Tests if update function works properly with null issue.
   */
  @Test
  public void testUpdateWithIssueNull() {
    testLine2.update();
    assertEquals(false, testLine2.isIssueExist());
  ...
  @Test
  void testIssue() {
    Boolean b = testLine2.isIssueExist();
